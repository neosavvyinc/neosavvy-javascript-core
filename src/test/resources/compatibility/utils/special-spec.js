describe("Neosavvy.Core.Utils.SpecialUtils", function () {
    ...
    describe("keepTrying", function () {
        ...
        it("Should return the value of the first function in the list if it does not throw an error", function () {
            expect(Neosavvy.Core.Utils.SpecialUtils.keepTrying(
                function () {
                    return 6;
                }, [], function () {
                    throw "Some error!";
